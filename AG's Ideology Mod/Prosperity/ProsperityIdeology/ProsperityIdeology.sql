...
VALUES	('POLICY_POP_ART',					'BUILDING_POP_ART',				'TXT_KEY_POLICY_POP_ART',					'TXT_KEY_POLICY_POP_ART_PEDIA',					'TXT_KEY_POLICY_POP_ART_HELP',					'POLICY_BRANCH_PROSPERITY',		10,          1,     10,            'POLICY_ATLAS_EXP2', 'POLICY_A_ATLAS_EXP2'),
		('POLICY_REGULATORY_CAPTURE',		'BUILDING_STOCK_EXCHANGE',		'TXT_KEY_POLICY_REGULATORY_CAPTURE',		'TXT_KEY_POLICY_REGULATORY_CAPTURE_PEDIA',		'TXT_KEY_POLICY_REGULATORY_CAPTURE_HELP',		'POLICY_BRANCH_PROSPERITY',		10,          1,     10,            'POLICY_ATLAS_EXP2', 'POLICY_A_ATLAS_EXP2'),
		...
		('POLICY_DIPLOMATIC_IMMUNITY',		NULL,							'TXT_KEY_POLICY_DIPLOMATIC_IMMUNITY',		'TXT_KEY_POLICY_DIPLOMATIC_IMMUNITY_PEDIA',		'TXT_KEY_POLICY_DIPLOMATIC_IMMUNITY_HELP',		'POLICY_BRANCH_PROSPERITY',     10,          2,     10,            'POLICY_ATLAS_EXP2', 'POLICY_A_ATLAS_EXP2'),
		...
		('POLICY_BIG_PHARMA',				NULL,							'TXT_KEY_POLICY_BIG_PHARMA',				'TXT_KEY_POLICY_BIG_PHARMA_PEDIA',				'TXT_KEY_POLICY_BIG_PHARMA_HELP',				'POLICY_BRANCH_PROSPERITY',     10,          2,     10,            'POLICY_ATLAS_EXP2', 'POLICY_A_ATLAS_EXP2'),
