...
INSERT INTO Buildings
        (Type,              BuildingClass,          Description,            Help,                           Civilopedia,                  Strategy,                         Cost, NumCityCostMod, NationalPopRequired,   PolicyBranchType,               PrereqTech,             MaxStartEra,    SpecialistType,               SpecialistCount,  GreatPeopleRateChange,  NukeImmune, HurryCostModifier,  MinAreaSize,    ConquestProb,   NeverCapture,   ExtraLeagueVotes,   NumTradeRouteBonus, TradeRouteLandDistanceModifier, TradeRouteLandGoldBonus, FreePolicies,      IconAtlas,  PortraitIndex)
VALUES  ('BUILDING_WTC',    'BUILDINGCLASS_WTC',    'TXT_KEY_BUILDING_WTC', 'TXT_KEY_BUILDING_WTC_HELP',    'TXT_KEY_BUILDING_WTC_PEDIA', 'TXT_KEY_BUILDING_WTC_STRATEGY',  1600, 10,             60,                   'POLICY_BRANCH_PROSPERITY',     'TECH_ELECTRONICS',     'ERA_FUTURE',   'SPECIALIST_CIVIL_SERVANT',   1,                1,                      1,          -1,                 -1,             0,              1,              2,                  1,                  25,                             100,                     1,                 'WTC_ATLAS',0);
