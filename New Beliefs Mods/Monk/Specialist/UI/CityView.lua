...
--Mod Additions
local preacherTexture = "citizenPreacher.dds";
local farmerTexture = "citizenFarmer.dds";
local generalistTexture = "citizenGeneralist.dds";
--end Additions
...
function AddBuildingButton( pCity, building )
	...
	if (pCity:IsHasBuilding(buildingID)) then
		...
		if building.SpecialistType then
			...
			elseif building.SpecialistType == "SPECIALIST_FARMER" then
				controlTable.BuildingFilledSpecialistSlot1:SetTexture(farmerTexture);
				controlTable.BuildingFilledSpecialistSlot2:SetTexture(farmerTexture);
				controlTable.BuildingFilledSpecialistSlot3:SetTexture(farmerTexture);
			elseif building.SpecialistType == "SPECIALIST_GENERALIST" then
				controlTable.BuildingFilledSpecialistSlot1:SetTexture(generalistTexture);
				controlTable.BuildingFilledSpecialistSlot2:SetTexture(generalistTexture);
				controlTable.BuildingFilledSpecialistSlot3:SetTexture(generalistTexture);
			else
